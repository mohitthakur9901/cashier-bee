...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 border-b-2 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke text-black p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
        ...
        <div className="flex items-center justify-between gap-5 2xsm:gap-7">
